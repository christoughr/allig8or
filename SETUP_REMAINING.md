...
| Starter | $149/mo → `NEXT_PUBLIC_LEMONSQUEEZY_VARIANT_STARTER` |
| Pro | $399/mo → `NEXT_PUBLIC_LEMONSQUEEZY_VARIANT_PRO` |
| Team | $999/mo → `NEXT_PUBLIC_LEMONSQUEEZY_VARIANT_TEAM` |
